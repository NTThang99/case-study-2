...
public class Startup {
    ...
    private static void initBooks() {
        Book book1 = new Book(1,"Tham tu lung danh Conan",9, Category.NOVEL,"Series manga trinh thám" ,"Aoyama Gōshō", Publisher.NHAXUATBANKIMDONG,12000.0, Status.INSTOCK,LocalDate.of(2023,11,7));
        Book book2 = new Book(2,"Trang Quynh",10, Category.COMICS,"Bộ truyện tranh thiếu nhi nhiều tập của Việt Nam" ," Kim Khánh", Publisher.NHAXUATBANKIMDONG,16000.0, Status.INSTOCK,LocalDate.of(2023,11,7));
        Book book3 = new Book(3,"Doraemon",15, Category.COMICS,"Hành trình của cậu bé tên là Nobita và nhóm bạn của cậu ấy" ," Motoo Abiko", Publisher.NHAXUATBANKIMDONG,16000.0, Status.INSTOCK,LocalDate.of(2023,11,7));
        Book book4 = new Book(4,"OnePiece",15, Category.COMICS,"Hành trình của cậu bé tên là Luffy trên con đường trở thành vua hải tặc" ,"Oda Eiichiro", Publisher.NHAXUATBANVANHOC,18000.0, Status.INSTOCK,LocalDate.of(2023,11,7));
        Book book5 = new Book(5,"Thuy hu",15, Category.NOVEL,"Sự hình thành và những thành tích của 108 anh hùng Lương Sơn Bạc chống lại triều đình mục nát" ,"Thi Nại Am", Publisher.NHAXUATBANVANHOC,14000.0, Status.INSTOCK,LocalDate.of(2023,11,7));
